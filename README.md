...
![Swift 5.0](https://img.shields.io/badge/swift-5.0-brightgreen?style=flat&logo=swift)
...
A robust and performant Swift 5.0 implementation of [RFC6570](https://tools.ietf.org/html/rfc6570) URI Template.  Full Level 4 support is provided.
...
### CocoaPods
Add `pod 'URITemplate', '~> 3.0'` to your Podfile

### Carthage
Add `github "jonnybach/URITemplate" ~> 3.0` to your Cartfile

### Swift Package Manager
Add `.package(url: "https://github.com/jonnybach/URITemplate.git", from: "3.0.0")` to your package.swift dependencies
